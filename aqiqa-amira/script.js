/* ═══════════════════════════════════════════════════════════════
   INVITATION — CÉRÉMONIE DE L'AQIQA · AMIRA
...
const WEDDING_CONFIG = {
  whatsappNumber: "212644301655",
  babyNameFr: "Amira",
  babyNameAr: "أميرة",
  /* 18 octobre 2026 à 20h00 (mois 9 = octobre, index JS) */
  weddingDate: new Date(2026, 9, 18, 20, 0, 0).getTime(),
  venue: "Salle de fête Floritta — Route de l'Ourika, Tassoultante",
  venueAr: "قاعة فوريتا — طريق أوريكا، تسولتانت",
  weddingDayText: "Dimanche 18 octobre 2026",
  weddingTimeText: "À partir de 20h00",
  weddingDayTextAr: "الأحد 18 أكتوبر 2026",
  weddingTimeTextAr: "ابتداءً من الساعة 20:00",
  rsvpDeadline: "Merci de confirmer avant le 18 octobre 2026",
  mapUrl: "https://maps.app.goo.gl/QUtP37GKojZrzvSq9?g_st=aw"
};
...
function buildWhatsAppMessage(data) {
  ...
  const messageText = data.message
    ? `\n\n💌 *Mon message pour la famille d'Amira / رسالتي لعائلة أميرة :*\n${data.message}`
    : "";

  const message =
`*🌸 Confirmation de présence — Aqiqa d'Amira 🌸*
*🌸 تأكيد الحضور — حفل عقيقة أميرة 🌸*
...
Qu'Allah bénisse Amira et la garde pour ses parents 🤍✨
بارك الله لكم في أميرة، وجعلها قرة عين لوالديها، وأنبتها نباتاً حسناً 🤍✨`;

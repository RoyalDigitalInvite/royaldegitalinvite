...
const WEDDING_CONFIG = {
  whatsappNumber: "212662528357",
  brideName: "ليان",
  groomName: "",
  weddingDate: new Date(2026, 8, 11, 18, 0, 0).getTime(),
  venue: "منزل العائلة — تجزئة النخيل، طنجة البالية",
  weddingDayText: "الجمعة 11 شتنبر 2026",
  weddingTimeText: "ابتداءً من الساعة 18:00",
  rsvpDeadline: "المرجو تأكيد الحضور قبل 11 شتنبر 2026"
};
/* ─── Reveal Animations ─── */
...
📍 *مكان الحفل:* ${WEDDING_CONFIG.venue}
📅 *التاريخ:* ${WEDDING_CONFIG.weddingDayText}
🕕 *الوقت:* ${WEDDING_CONFIG.weddingTimeText}${messageText}

بارك الله لكم في ليان، وجعلها قرة عين لوالديها، وأنبتها نباتاً حسناً 🤍✨`;
